...
- [1. Hono とは何か](#1-hono-とは何か)
  - [1.1 概要](#11-概要)
  - [1.2 基本情報](#12-基本情報)
- [2. 本プロジェクトでの使用](#2-本プロジェクトでの使用)
  - [2.1 使用場所](#21-使用場所)
  - [2.2 なぜ Next.js の API Route に Hono を使うのか](#22-なぜ-nextjs-の-api-route-に-hono-を使うのか)
- [3. Hono の基本概念](#3-hono-の基本概念)
  - [3.1 最小限のアプリケーション](#31-最小限のアプリケーション)
  - [3.2 Hono と Echo の対比](#32-hono-と-echo-の対比)
  - [3.3 ルーティング](#33-ルーティング)
  - [3.4 ミドルウェア](#34-ミドルウェア)
- [4. Next.js での Hono 統合パターン](#4-nextjs-での-hono-統合パターン)
  - [4.1 App Router での統合](#41-app-router-での統合)
  - [4.2 BFF（Backend for Frontend）パターン](#42-bffbackend-for-frontendパターン)
- [5. Hono の特徴的な機能](#5-hono-の特徴的な機能)
  - [5.1 Web Standards API ベース](#51-web-standards-api-ベース)
  - [5.2 型安全な RPC クライアント](#52-型安全な-rpc-クライアント)
  - [5.3 組み込みミドルウェア一覧](#53-組み込みミドルウェア一覧)
  - [5.4 バリデーション（Zod連携）](#54-バリデーションzod連携)
- [6. Hono vs Express vs Fastify](#6-hono-vs-express-vs-fastify)
- [7. Hono と Echo の設計思想の共通点](#7-hono-と-echo-の設計思想の共通点)
- [8. まとめ：学習ポイント](#8-まとめ学習ポイント)
