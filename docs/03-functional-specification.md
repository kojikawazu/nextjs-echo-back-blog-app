...
- [1. 認証機能](#1-認証機能)
  - [1.1 認証フロー全体像](#11-認証フロー全体像)
  - [1.2 ログイン処理詳細](#12-ログイン処理詳細)
  - [1.3 認証確認処理詳細](#13-認証確認処理詳細)
  - [1.4 ログアウト処理詳細](#14-ログアウト処理詳細)
- [2. ブログ管理機能](#2-ブログ管理機能)
  - [2.1 ブログ作成フロー](#21-ブログ作成フロー)
  - [2.2 ブログ更新フロー](#22-ブログ更新フロー)
  - [2.3 ブログ削除フロー](#23-ブログ削除フロー)
  - [2.4 ブログ一覧取得](#24-ブログ一覧取得)
  - [2.5 カテゴリ・タグ取得](#25-カテゴリタグ取得)
- [3. いいねシステム](#3-いいねシステム)
  - [3.1 訪問者ID管理フロー](#31-訪問者id管理フロー)
  - [3.2 いいね追加フロー](#32-いいね追加フロー)
  - [3.3 いいね削除フロー](#33-いいね削除フロー)
  - [3.4 いいね状態確認フロー](#34-いいね状態確認フロー)
- [4. コメントシステム](#4-コメントシステム)
  - [4.1 コメント投稿フロー](#41-コメント投稿フロー)
  - [4.2 コメント一覧取得フロー](#42-コメント一覧取得フロー)
- [5. ユーザープロフィール管理](#5-ユーザープロフィール管理)
  - [5.1 プロフィール取得フロー](#51-プロフィール取得フロー)
  - [5.2 プロフィール更新フロー](#52-プロフィール更新フロー)
- [6. 共通仕様](#6-共通仕様)
  - [6.1 APIエンドポイント一覧](#61-apiエンドポイント一覧)
  - [6.2 認証方式の分類](#62-認証方式の分類)
  - [6.3 レスポンス形式](#63-レスポンス形式)
  - [6.4 CORS設定](#64-cors設定)
  - [6.5 依存性注入（DI）構成](#65-依存性注入di構成)
  - [6.6 サーバー起動・停止](#66-サーバー起動停止)
...
| 認証失敗（ユーザー未発見・DB取得失敗を含む） | 401 | Invalid credentials |
